	...
	collections.declareClass("List", {
		...
		members: {
			...
			*/
			add: function(item) {
				if(item === undefined) {
					throw new joopl.ArgumentException({ memberName: "item", reason: "Undefined values are not supported" });
				}
			...
			*/
			insertAt: function(index, item) {
				if(index >= this.count()) {
					throw new joopl.ArgumentException({ memberName: "index", reason: "Index out of range" });
				}
			...
			*/
			...
			skip: function(numberOfItems) {
				if(numberOfItems > this.count()) {
					throw new joopl.ArgumentException({ memberName: "numberOfItems", reason: "Out of range" });
				}
