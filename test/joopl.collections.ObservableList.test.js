            ...
            members: {
                changed_checkChangeEventIsRaisedWhenSomeChangeIsProduced_changeEventWasFired: function() {
                    ...
                    list.changed.addEventListener(function (args) {
                        ...
                        equal(args.changeKind, collections.ObservableChange.added, "As items are added to the list, the notifier must report that an item was added");
                    });
                    ...
                    equal(changeCount, 3, "The list must notify that it changed three times");
                }
            }
        });
