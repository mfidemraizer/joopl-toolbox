...
(function (undefined) {
            ...
            if (parent != null) {
                ...
                for (var memberName in parent.prototype) {
                    if (!this.isSystemReservedName(memberName)) {
                        if (typeof parent.prototype[memberName] == "function") {
    ...
    $class = {
        ...
        declare: function (args) {
            ...
            if (args.$members) {
                for (var memberName in args.$members) {
                    if (typeof args.$members[memberName] == "function") {
        ...
        create: function (classDefOrInstance, args) {
            if ($class.isClass(classDefOrInstance)) {
                var instance = typeof classDefOrInstance == "function" ? new classDefOrInstance() : classDefOrInstance;
    ...
    $global.joopl.Object.prototype.joopl = version;
    $global.joopl.Object.prototype.typeKind = "class";

    $global.joopl.Object.prototype.is = function (clazz) {
        var allBases = [];
        var lastBase = this;
        var isMember = false;
